...
class ConsultasMailService {
    ...
    constructor(http) {
        this.http = http;
        this.rootURL = 'https://tursarg.azurewebsites.net/api';
    }
...
class UrlService {
    constructor() {
        this.urlRegistro = 'https://tursarg.azurewebsites.net/api';
        this.urlLogin = 'https://tursarg.azurewebsites.net/api/USUARIOS1/login';
    }
}
